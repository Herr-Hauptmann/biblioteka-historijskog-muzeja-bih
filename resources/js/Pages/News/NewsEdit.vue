...
<template>
    <Head title="Izmjena priče" />
    <Content>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Izmjena priče iz biblioteke</h2>
        </template>
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-4">
                    ...
                    <form @submit.prevent="submit">
                        <div class="grid gap-6 mb-6 md:grid-cols-2">
                            <div>
                                ...
                                <div class="mt-3">
                                    ...
                                    <input name="image" @input="form.image = $event.target.files[0]"  class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50" aria-describedby="image_help" id="image" type="file">
                                    <p class="mt-1 text-sm text-gray-500" id="image_help">Odaberite sliku vezanu za ovu priču</p>
                                    ...
                                    <FormInputLabel what="image" msg="Trenutna fotografija"/>
                                    <div>
                                        <img :src="image_path" alt="Prethodna fotografija" class="w-20">
                                    </div>
                                </div>
                            </div>
                            <div>
                        ...
                        <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center">Izmjeni priču</button>
                    </form>
                </div>
            </div>
        </div>
